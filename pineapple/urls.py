...
urlpatterns = [
    ...
    path('seller-list/' ,  views_sellers.seller_list_view , name='seller-list'),
    path('seller-create/' ,  views_sellers.seller_create_view , name='seller-create'),
    path('seller-detail/<int:certificate_code>/' ,  views_sellers.seller_detail_view , name='seller-detail'),
    path('seller-update/<int:certificate_code>/' ,  views_sellers.seller_update_view , name='seller-update'),
    ...
    path('seller-comment-list/<int:certificate_code>' ,  views_comments.seller_comment_list_view , name='seller-comment-list')
]
